...
<h3>
    E-mail: </br><input type="email" name="lname"><br></br>
  CPF: </br><input type="password" name="lname"><br>
 <br/>
  <input type="submit" value="Recuperar"style="width: 200px; height: 30px" >
</h3> 
    
    <h4>
        Obs.: Ap&oacute;s clicar em "Recuperar" sua senha ser&aacute; seu cpf e voc&ecirc; poder&aacute alterar na pagina do usu&aacuterio.
    </h4>
